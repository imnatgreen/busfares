<script lang="ts">
  ...
  import apply from 'ol-mapbox-style?client';
  ...
  // applyStyle(vectorTileLayer, 'https://tiles.nat.omg.lol/voyager.json');
  // applyBackground(vectorTileLayer, 'https://tiles.nat.omg.lol/voyager.json');
  ...
  onMount(() => {
    map = new Map({
      ...
      layers: [
        ...
        //     attributions: '<a href=\"https://www.openmaptiles.org/\" target=\"_blank\">&copy; OpenMapTiles</a> <a href=\"https://www.openstreetmap.org/copyright\" target=\"_blank\">&copy; OpenStreetMap contributors</a>',
        //     format: new MVT(),
        //     url: 'https://tiles.nat.omg.lol/{z}/{x}/{y}.pbf'
        //   }),
      ...
      view: new View(extent ? {
        ...
        center: fromLonLat(view),
        zoom: zoom,
      }),
    });
    apply(map, 'https://tiles.nat.omg.lol/voyager-manrope.json');
    // apply(map, 'https://api.maptiler.com/maps/voyager-v2/style.json?key=OmDUzyEONpvREG37gyU3');
...
<div bind:this={mapContainer} id="map" class={classes}></div>