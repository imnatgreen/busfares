...
<div class="flex flex-col md:flex-row w-full h-screen p-4 gap-4 bg-gradient-to-br from-pink-50 via-purple-50 to-indigo-200">
  <div class="h-1/2 md:h-full md:w-1/2 overflow-hidden flex-none rounded-lg shadow-lg bg-white">
    <div class="w-full h-full p-4 overflow-auto">
      ...
      <div class="mt-1 flex flex-row gap-1 flex-wrap">
        <div class="relative">
          ...
          <select
            ...
            class="
              px-2 pl-7 pr-6 py-1 block rounded-md  border-gray-300 shadow-sm
              focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50
            "
          >
        ...
        <div class="relative">
          <button on:click={() => datePicker.showPicker()} class="absolute inset-y-0 left-0 flex items-center pl-2 text-gray-500">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
        ...
        <div class="relative">
          <button on:click={() => timePicker.showPicker()} class="absolute inset-y-0 left-0 flex items-center pl-2 text-gray-500">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
      ...
      <div class="relative mt-1">
        ...
        focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">find journey</button>
      </div>
